...
var CargarFrmAoM :Function = () =>{
    ...
    ajax.Post("http://localhost/TP1ProgyLabGeneral(AJAX)/indexBD.php",SuccessAoM,"");    
}

var CargarFrmMostrar:Function = () =>{

    let ajax : AjaxBD = new AjaxBD();
    ajax.Post("http://localhost/TP1ProgyLabGeneral(AJAX)/backendBD/mostrar_BD.php",SuccessMostrar,"");    
}
...
var CargarDatos : Function = () =>{
    ...
    ajax.Post("http://localhost/TP1ProgyLabGeneral(AJAX)/backendBD/administracion_BD.php",Recargar,form);
...
var AModificar :  Function = (dni : string)=>{
    ...
    ajax.Post("http://localhost/TP1ProgyLabGeneral(AJAX)/indexBD.php",SuccessAoM,param);
}
...
var AEliminar : Function = (legajo : string)=>{
    ...
    ajax.Get("http://localhost/TP1ProgyLabGeneral(AJAX)/backendBD/eliminar_BD.php",CargarFrmMostrar,param);
}
